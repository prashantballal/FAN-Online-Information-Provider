...
public partial class AddNovel : System.Web.UI.Page
{
    ...
    {
        string nov_name = txtNovelName.Text;
        ...
        try
        {
            ...
            con = new SqlConnection(ConfigurationManager.ConnectionStrings["11project"].ToString());
            con.Open();
            string insert = "insert into novels(novel_name, image, writer_name, publisher_name, release_date, description) values('" + nov_name + "', '" + path + "', '" + wr_name + "', '" + pub_name + "', '" + Convert.ToDateTime(date) + "', '" + desc + "')";
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            cmd2 = new SqlCommand("update novels set image='" + path + "' where novel_name='" + txtNovelName.Text + "'", con);
            ...
            con = new SqlConnection(ConfigurationManager.ConnectionStrings["11project"].ToString());
            con.Open();
            string query = "select image from novels where novel_name='" + txtNovelName.Text + "'";
