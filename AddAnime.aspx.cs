...
public partial class AddAnime : System.Web.UI.Page
{
    SqlConnection con;
    ...
    {
        string an_name = txtAnimeName.Text;
        ...
        try
        {
            ...
            con = new SqlConnection(ConfigurationManager.ConnectionStrings["11project"].ToString());
            con.Open();
            string insert = "insert into animes(anime_name, image, creator_name, producer_name, release_date, description) values('" + an_name + "', '" + path + "', '" + cr_name + "', '" + pr_name + "', '" + Convert.ToDateTime(date) + "', '" + desc + "')";
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            cmd2 = new SqlCommand("update animes set image='" + path + "' where anime_name='" + txtAnimeName.Text + "'", con);
            ...
            con = new SqlConnection(ConfigurationManager.ConnectionStrings["11project"].ToString());
            con.Open();
            string query = "select image from animes where anime_name='" + txtAnimeName.Text + "'";
