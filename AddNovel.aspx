<%@ Page Title="FAN- Admin ~ Add Novel" Language="C#" MasterPageFile="~/MasterPageMain.master" AutoEventWireup="true" CodeFile="AddNovel.aspx.cs" Inherits="AddNovel" %>
...
<asp:Image ID="Image2" runat="server" ImageUrl="~/Images/INDICIUM[db].png"></asp:Image>
    ...
    <br />
    <br />
    <asp:Label ID="lblMsg" runat="server" Text="ADD NOVEL" Font-Names="Calibri" Font-Size="XX-Large" ForeColor="#006699" Font-Bold="True" Font-Underline="True"></asp:Label>
    <br />
    <br />
    <br />
