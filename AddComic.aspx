<%@ Page Title="FAN - Add Comic Book" Language="C#" MasterPageFile="~/MasterPageMain.master" AutoEventWireup="true" CodeFile="AddComic.aspx.cs" Inherits="ddComic" %>
...
<asp:Image ID="Image2" runat="server" ImageUrl="~/Images/INDICIUM[db].png"></asp:Image>
    ...
    <br />
    <br />
    <asp:Label ID="lblMsg" runat="server" Text="ADD COMIC" Font-Names="Calibri" Font-Size="XX-Large" ForeColor="#006699" Font-Bold="True" Font-Underline="True"></asp:Label>
    <br />
    <br />
    <br />
        ...
        <asp:Button ID="Button2" runat="server" Text="Upload" CssClass="btn" BackColor="Black" Height="30px" Width="100px" OnClick="Button2_Click"></asp:Button>
           ...
           <table style="height: 330px; width: 525px">
               <tr>
                   ...
                   <td>
                       <asp:TextBox ID="txtCBName" runat="server" Width="300px" CssClass="TextBox"></asp:TextBox>
                   </td>
               </tr>
               ...
               <tr>
                   <td class="auto-style1">
                       <asp:Label ID="Label6" runat="server" Text="Drawn by:" Font-Names="Calibri" Font-Size="X-Large" ForeColor="#006699"></asp:Label>
                   </td>
                   <td>
                       <asp:TextBox ID="txtArtistName" runat="server" Width="300px" CssClass="TextBox"></asp:TextBox>
                   </td>
               </tr>
