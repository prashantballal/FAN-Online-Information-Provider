<%@ Page Title="FAN - Add Movie" Language="C#" MasterPageFile="~/MasterPageMain.master" AutoEventWireup="true" CodeFile="AddMovie.aspx.cs" Inherits="AddMovie" %>
...
<asp:Image ID="Image2" runat="server" ImageUrl="~/Images/INDICIUM[db].png"></asp:Image>
    ...
    <br />
    <br />
    <asp:Label ID="lblMsg" runat="server" Text="ADD MOVIE" Font-Names="Calibri" Font-Size="XX-Large" ForeColor="#006699" Font-Bold="True" Font-Underline="True"></asp:Label>
    <br />
    <br />
    <br />
        ...
        <asp:Button ID="Button2" runat="server" Text="Upload" CssClass="btn" BackColor="Black" Height="30px" Width="100px" OnClick="Button2_Click"></asp:Button>
           ...
           <table style="height: 330px; width: 525px">
               <tr>
                   ...
                   <td>
                       <asp:TextBox ID="txtMovieName" runat="server" Width="300px" CssClass="TextBox"></asp:TextBox>
                   </td>
               </tr>

               <tr>
                   <td class="auto-style1">
                       <asp:Label ID="Label7" runat="server" Text="Written by:" Font-Size="X-Large" ForeColor="#006699" Font-Names="Calibri"></asp:Label>
                   </td>
                   <td>
               ...
               <tr>
                   <td class="auto-style1">
                       <asp:Label ID="Label2" runat="server" Text="Directed by:" Font-Names="Calibri" Font-Size="X-Large" ForeColor="#006699"></asp:Label>
                   </td>
                   <td>
                       <asp:TextBox ID="txtDirectorName" runat="server" Width="300px" CssClass="TextBox"></asp:TextBox>
                   </td>
               </tr>
               ...
               <tr>
                   <td class="auto-style1">
                       <asp:Label ID="Label6" runat="server" Text="Starring:" Font-Names="Calibri" Font-Size="X-Large" ForeColor="#006699"></asp:Label>
                   </td>
                   <td>
                       <asp:TextBox ID="txtStarring" runat="server" Width="300px" CssClass="TextBox" TextMode="MultiLine"></asp:TextBox>
                   </td>
               </tr>
